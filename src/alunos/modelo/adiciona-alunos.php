<?php
    ...
    // A função strlen do PHP conta a quantidade de caractere existente dentro da variável
    if(strlen($nome) <= 0 && strlen($curso) <= 0 && strlen($senha) <= 0 && strlen($tipo) <= 0){
        ...
        // Quando trabalhamos com senha é muito importante criptografar a senha no PHP podemos uma base64 e MD5
